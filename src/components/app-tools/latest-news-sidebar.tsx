...
export function LatestNewsSidebar({ posts }: LatestNewsSidebarProps) {
  ...
  return (
    <div className="bg-[#0d110e]/40 border border-white/10 rounded-xl p-5 shadow-lg">
      ...
      <div className="flex flex-col gap-4">
        {posts.map((post) => {
          ...
          return (
            ...
            >
              <h4 className="text-sm font-medium text-white/84 group-hover:text-primary transition-colors line-clamp-2 leading-tight">
                {post.title}
              </h4>
