    ...
    >
      <div style={{ display: 'flex', justifyContent: 'center', width: '100%', maxWidth: '325px', minHeight: '600px' }}>
        {shouldLoad ? (
          ...
          <div className="w-[325px] h-[600px] bg-[#0d110e] rounded-lg flex items-center justify-center border border-white/10">
            <div className="text-center space-y-2">
              <div className="w-12 h-12 mx-auto rounded-full bg-[#111512] flex items-center justify-center">
                <svg className="w-6 h-6 text-white/58" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
                </svg>
              </div>
              <p className="text-sm text-white/58">TikTok Video</p>
            </div>
          </div>
        )}
      </div>
