      ...
      case 'inicio':
        return (
          <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <p className="text-xl text-white/58 mb-10 leading-relaxed max-w-3xl">
      ...
      case 'que-es':
        return (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-xl text-white/78 mb-8 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="bg-[#141414] p-6 rounded-xl border border-white/5 shadow-md">
                ...
                <p className="text-sm text-white/58">Un estándar libre y abierto para toda la industria, no bloqueado por un solo proveedor.</p>
              </div>
              <div className="bg-[#141414] p-6 rounded-xl border border-white/5 shadow-md">
                <Shield className="w-8 h-8 text-[#ff6b4a] mb-4" />
                <h3 className="text-lg font-bold text-white mb-2">Seguridad Local</h3>
                <p className="text-sm text-white/58">Tus datos nunca abandonan tu máquina a menos que la IA los solicite explícitamente y tú lo apruebes.</p>
              </div>
              <div className="bg-[#141414] p-6 rounded-xl border border-white/5 shadow-md">
                <Zap className="w-8 h-8 text-[#ff6b4a] mb-4" />
                <h3 className="text-lg font-bold text-white mb-2">Plug & Play</h3>
                <p className="text-sm text-white/58">Conecta bases de datos, APIs y sistemas de archivos locales en cuestión de minutos.</p>
              </div>
            </div>
          </div>
        );
      ...
      case 'conceptos':
        return (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-lg text-white/58 mb-8">Para dominar MCP y conectarlo a las <Link href="/soluciones" className="text-[#ff6b4a] hover:underline">necesidades de automatización</Link> de tu empresa, necesitas entender su arquitectura fundamental: Clientes, Servidores y primitivas.</p>
            ...
            <div className="space-y-8">
              <div className="bg-[#141414] border border-white/10 rounded-2xl p-8">
                ...
                <ul className="space-y-6 text-white/78">
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/58">Aplicaciones orientadas al usuario como Claude Desktop o IDEs innovadores como Cursor que inician la conexión y muestran la interfaz de la IA.</p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    <CheckCircle2 className="w-6 h-6 text-[#ff6b4a] shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-white/58">El código dentro del Host que mantiene la comunicación bidireccional segura con los servidores.</p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    <CheckCircle2 className="w-6 h-6 text-[#ff6b4a] shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-white/58">Programas ligeros que exponen capacidades específicas. Por ejemplo, un “Servidor de PostgreSQL” que permite ejecutar consultas SQL sobre ventas corporativas directamente desde el chat.</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] border border-white/10 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-[#0a0a0a] p-6 rounded-xl border border-white/5">
                    ...
                    <p className="text-sm text-white/58 leading-relaxed">Datos controlados por el servidor que el cliente puede leer. Piensa en ellos como archivos locales, respuestas de API o esquemas transaccionales. Son de solo lectura.</p>
                  </div>
                  <div className="bg-[#0a0a0a] p-6 rounded-xl border border-white/5">
                    <h4 className="text-[#ff6b4a] font-bold mb-3 text-lg">2. Tools</h4>
                    <p className="text-sm text-white/58 leading-relaxed">Funciones que potencian el flujo automatizado: <code className="text-xs bg-white/10 px-1 py-0.5 rounded">execute_sql</code>, <code className="text-xs bg-white/10 px-1 py-0.5 rounded">github_pr</code>. Permiten a la IA tomar acciones de impacto real en tus entornos.</p>
                  </div>
                  <div className="bg-[#0a0a0a] p-6 rounded-xl border border-white/5">
                    <h4 className="text-[#ff6b4a] font-bold mb-3 text-lg">3. Prompts</h4>
                    <p className="text-sm text-white/58 leading-relaxed">Plantillas diseñadas. Ayudan a los usuarios a interactuar óptimamente con agentes complejos sin dominar prompt engineering sofisticado.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      case 'instalacion':
        return (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-lg text-white/58 mb-8">La forma de instalar un servidor depende del <strong>Host (Cliente)</strong> que utilices. Entender cómo conectar estas IAs a tu empresa es el primer peldaño hacia la nueva <Link href="/blog" className="text-[#ff6b4a] hover:underline">estrategia digital B2B</Link>.</p>
            ...
            <div className="space-y-8">
              <div className="bg-[#141414] border border-white/10 rounded-2xl p-8">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-white/58 mb-3">Edita el archivo <code className="text-sm bg-white/10 px-1.5 py-0.5 rounded text-white/78">claude_desktop_config.json</code>:</p>
                  <div className="space-y-2">
                    <div className="bg-[#0a0a0a] p-3 rounded-lg border border-white/5 font-mono text-sm text-white/78">
                      <span className="text-white/45">Mac:</span> ~/Library/Application Support/Claude/claude_desktop_config.json
                    </div>
                    <div className="bg-[#0a0a0a] p-3 rounded-lg border border-white/5 font-mono text-sm text-white/78">
                      <span className="text-white/45">Windows:</span> %APPDATA%\Claude\claude_desktop_config.json
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-white/58 mb-3">Agrega la configuración JSON apuntando al servidor. Ejemplo SQLite:</p>
      ...
      "args": [
        ...
        "C:/ruta/absoluta/a/tu/base_de_datos.db"
              ...
              <div className="bg-[#141414] border border-white/10 rounded-2xl p-8">
                ...
                <p className="text-white/58 mb-6">En editores de código modernos enfocados en IA (como Cursor), la configuración suele ser directa en su interfaz gráfica:</p>
                <ol className="space-y-4 text-white/78 list-decimal list-inside marker:text-[#ff6b4a] marker:font-bold">
                  ...
                  <li className="pl-2">
                    ...
                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1 text-white/58">
      ...
      case 'arquitectura':
        return (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-lg text-white/58 mb-8">
              ...
              <div className="bg-[#141414] border border-white/10 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-[#0a0a0a] p-6 rounded-xl border border-white/5">
                    ...
                    <p className="text-sm text-white/58 leading-relaxed">Máxima seguridad local subproceso. Ideal para escritorios de trabajo y código confidencial donde no quieres exponer puertos LAN/WAN.</p>
                  </div>
                  <div className="bg-[#0a0a0a] p-6 rounded-xl border border-white/5">
                    ...
                    <p className="text-sm text-white/58 leading-relaxed">Conexión web HTTP para equipos distribuidos que necesitan consultar clusters remotos o bases de datos Cloud protegidas.</p>
                  </div>
                </div>
              </div>
                ...
                <ul className="space-y-6 text-white/78">
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/58 text-sm leading-relaxed">Los agentes no deciden por su cuenta borrar tablas o enviar emails promocionales; MCP escala los requests destructivos o inciertos al GUI para validación manual.</p>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      case 'servidores':
        return (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-lg text-white/58 mb-8">Extiende la memoria de tus asistentes hoy mismo con conectores que impulsan las ventas y la logística.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="bg-[#141414] p-6 rounded-2xl border border-white/10 hover:border-[#ff6b4a]/50 transition-colors cursor-default">
                ...
                <p className="text-sm text-white/58 mb-4">Pregunta a tu sistema métricas de retención, logística de envíos o LTV de clientes sin usar SQL.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">PostgreSQL</span>
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">Supabase</span>
                </div>
              </div>
              ...
              <div className="bg-[#141414] p-6 rounded-2xl border border-white/10 hover:border-[#ff6b4a]/50 transition-colors">
                ...
                <p className="text-sm text-white/58 mb-4">Audita ramas, lee el progreso de los pull requests y rastrea commits que causaron caídas críticas.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">GitHub</span>
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">GitLab</span>
                </div>
              </div>
              ...
              <div className="bg-[#141414] p-6 rounded-2xl border border-white/10 hover:border-[#ff6b4a]/50 transition-colors">
                ...
                <p className="text-sm text-white/58 mb-4">Interconecta canales de mensajería para que tus agentes puedan notificar alertas o resumir retrospectivas corporativas.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">Slack</span>
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">Zendesk</span>
                </div>
              </div>
              ...
              <div className="bg-[#141414] p-6 rounded-2xl border border-white/10 hover:border-[#ff6b4a]/50 transition-colors">
                ...
                <p className="text-sm text-white/58 mb-4">Conector puente entre la IA y tus intranets ricas en contextos corporativos como SOPs y guiones de venta.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">Google Drive</span>
                  <span className="text-xs bg-white/5 px-2 py-1 rounded text-white/78">Notion</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#ff6b4a]/20 to-transparent p-8 rounded-2xl border border-[#ff6b4a]/30">
              ...
              <p className="text-white/78 mb-4">Si necesitas un conector propio para tu CRM Privado o software de logística regional, nuestro equipo en Nitro Ecom puede estructurarlo usando el SDK de TS/Python.</p>
      ...
      case 'ejemplos':
        return (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-lg text-white/58 mb-8">Así revolucionan su productividad las agencias que integran ecosistemas MCP a sus flujos.</p>
            ...
            <div className="space-y-6">
              <div className="bg-[#141414] border border-white/10 rounded-2xl p-8">
                ...
                <p className="text-white/78 mb-6 leading-relaxed">
                ...
                <div className="bg-[#0a0a0a] p-5 rounded-xl border border-white/5 space-y-4">
                  <div>
                    ...
                    <em className="text-white/78">“Quiero la lista agrupada de los 5 clientes con ventas estancadas hace 3 meses en Shopify Plus e información cruzada de marketing.”</em>
                  </div>
                  <div>
                    <strong className="text-[#ff6b4a] text-sm uppercase tracking-wider block mb-1">Cálculo de la IA:</strong>
                    <span className="text-white/58 text-sm">El Claude conectando con servidor MCP SQL genera queries de agregación y devuelve una respuesta natural lista para una campaña de Email.</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      case 'consejos':
        return (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-lg text-white/58 mb-8">¿Desarrollando tu propio Servidor MCP? El tooling es muy joven pero maduro.</p>
    ...
    <>
      ...
      <header className="xl:hidden flex items-center justify-between p-4 border-b border-white/10 bg-[#0a0a0a]/90 backdrop-blur-md fixed top-[64px] lg:top-[64px] left-0 right-0 z-[60]">
        ...
        <button 
          ...
          className="p-2 text-white/58 hover:text-white bg-white/5 rounded-lg cursor-pointer transition-colors"
        >
      ...
      {/* Sidebar Navigation */}
      <aside className={` fixed xl:sticky top-[64px] xl:top-[128px] left-0 h-[calc(100vh-64px)] xl:h-[calc(100vh-128px)] w-72 bg-[#0a0a0a] xl:bg-transparent border-r border-white/5 xl:border-0 flex flex-col z-[50] transition-transform duration-300 ease-in-out shrink-0 xl:py-10 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full xl:translate-x-0'}
      `}>
        <div className="px-6 hidden xl:block">
          ...
          <p className="text-[10px] text-white/45 font-mono uppercase tracking-widest mt-4 ml-1">Tecnología Base 2026</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-4 px-4 pt-24 xl:pt-8 space-y-1 custom-scrollbar">
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                <item.icon className={`w-5 h-5 transition-colors ${isActive ? 'text-[#ff6b4a]' : 'text-white/45 group-hover:text-white/78'}`} />
                {item.label}
              </button>
            );
          })}
