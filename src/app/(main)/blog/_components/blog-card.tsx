...
export function BlogCard({ post }: BlogCardProps) {
  ...
  return (
    <Card className="flex flex-col h-full hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300 bg-zinc-900/50 border-zinc-800 hover:border-emerald-500/30 group overflow-hidden">
      {/* Image Section */}
      {imageUrl && (
      ...
      <div className="flex flex-col flex-1 p-4">
        <CardTitle className="leading-tight text-lg text-white group-hover:text-emerald-400 transition-colors line-clamp-2 mb-3">
          {post.title}
        </CardTitle>
        ...
        <Button asChild variant="outline" className="w-full border-zinc-700 hover:bg-zinc-800 text-zinc-300 mt-auto">
