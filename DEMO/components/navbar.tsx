...
export function Navbar({ onContactClick }: NavbarProps) {
  ...
  return (
    <>
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden bg-white/60 backdrop-blur-xl border-t border-white/20"
            >
      ...
      <motion.button
        onClick={scrollToBooking}
        className="md:hidden fixed bottom-6 right-6 z-50 bg-gradient-to-r from-amber-300 to-amber-500 hover:from-amber-400 hover:to-amber-600 text-stone-900 px-6 py-3 rounded-full text-sm font-medium shadow-xl shadow-amber-500/40"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
